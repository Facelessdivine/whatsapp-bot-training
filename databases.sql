...
VALUES
    ...
    (
        1,
        2,
        'Entrenamiento de velocidad en intervalos (8x400m) a 15-18 km/h con descanso de 1 minuto entre cada repetición.'
    ),
    (1, 3, 'Descanso'),
    ...
    (
        1,
        5,
        'Entrenamiento de fuerza (sentadillas, estocadas, zancadas)'
    ),
    (1, 6, 'Descanso'),
    ...
    (
        2,
        2,
        'Entrenamiento de velocidad en intervalos (10x400m) a 16-19 km/h con descanso de 1 minuto entre cada repetición'
    ),
    (2, 3, 'Descanso'),
    ...
    (
        3,
        2,
        'Entrenamiento de velocidad en intervalos (12x400m) a 17-20 km/h con descanso de 1 minuto entre cada repetición'
    ),
    (3, 3, 'Descanso'),
    ...
    (
        4,
        1,
        'Correr 8k a 13-15 km/h (ritmo moderado-rápido)'
    ),
    (
        4,
        2,
        'Entrenamiento de velocidad en intervalos (14x400m) a 18-21 km/h con descanso de 1 minuto entre cada repetición'
    ),
    (4, 3, 'Descanso'),
    (
        4,
        4,
        'Correr 10k a 13-15 km/h (ritmo moderado-rápido)'
    ),
    (
        4,
        5,
    ...
    (
        4,
        7,
        'Correr 13k a 13-15 km/h (ritmo moderado-rápido)'
    );
    ...
    INSERT INTO Warmup
           ...
           ,forcetraining)
     VALUES
           (1,'Comienza con 5-10 minutos de caminata ligera, seguido de ejercicios dinámicos como saltos y ejercicios de movimiento lateral para preparar tu cuerpo para el entrenamiento.','Después del entrenamiento, dedica unos minutos a estirar los músculos que trabajaste, como los cuádriceps, isquiotibiales, glúteos y pantorrillas.
Ejemplos de entrenamiento de fuerza: Burpees, flexiones de brazos, sentadillas con salto.','Salmón asado con verduras al vapor y quinoa, ensalada de pollo a la parrilla con aguacate y nueces.',''),
           (2,'Comienza con 5-10 minutos de trote ligero, seguido de ejercicios de movimiento dinámico para preparar tu cuerpo para el entrenamiento.
Estiramientos: Dedica unos minutos después del entrenamiento para estirar los músculos que trabajaste, como los músculos de las piernas, la espalda y los hombros.','','Pollo a la parrilla con arroz integral y verduras, ensalada de garbanzos con espinacas y tomates.','Zancadas con pesas, flexiones de brazos con mancuernas, elevaciones laterales con mancuernas.'),
           (3,'Comienza con 10 minutos de trote suave, seguido de ejercicios de movilidad articular para preparar tu cuerpo para el entrenamiento.','Dedica unos minutos después del entrenamiento para estirar todos los grupos musculares principales.','Salmón a la parrilla con batata asada y ensalada de col rizada, arroz integral con lentejas y espinacas.','Peso muerto, prensa de piernas, press de hombros con mancuernas.'),
           (4,'Comienza con 10 minutos de trote suave, seguido de ejercicios de movilidad y dinámicos para preparar tu cuerpo para el entrenamiento.','Dedica unos minutos después del entrenamiento para estirar todos los grupos musculares principales.','Ensalada de pollo con aguacate y quinoa, salteado de tofu con verduras y arroz integral.','Fondos en paralelas, sentadillas con salto y mancuernas, remo con barra.');
